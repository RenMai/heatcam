...
// TODO: save port name
// TODO: tests
public class LeptonCameraOld implements ThermalCamera, SerialInputOutputManager.Listener {
    ...
    public LeptonCameraOld(int width, int height) {
        this.width = width;
        this.height = height;
    ...
    public LeptonCameraOld(CameraListener listener) {
